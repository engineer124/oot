...
typedef enum {
    ...
    /* 0x19 */ CAM_SET_FIXED_LOCKED, // Camera is fixed in position and rotation "PREREND0"
    /* 0x1A */ CAM_SET_FIXED_PIVOT, // Camera is fixed in position with fixed pitch, but is free to rotate in the yaw direction 360 degrees "PREREND1"
    /* 0x1B */ CAM_SET_FIXED_SIDE_SCROLL, // Camera side-scrolls position to follow the player. Only used in castle courtyard with the guards "PREREND3"
