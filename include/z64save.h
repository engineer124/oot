...
#define EVENTCHKINF_ENTERED_ROYAL_FAMILYS_TOMB 0x5A
...
#define EVENTCHKINF_WATCHED_HYRULE_FIELD_GET_OOT_CS 0xA9
#define EVENTCHKINF_AA 0xAA
#define EVENTCHKINF_AC 0xAC
#define EVENTCHKINF_DISPELLED_SPIRIT_BARRIER 0xAD
...
#define EVENTCHKINF_ENTERED_JABU_JABU 0xB5
...
#define EVENTCHKINF_ENTERED_OUTSIDE_GANONS_CASTLE 0xBA
#define EVENTCHKINF_DISPELLED_FOREST_BARRIER 0xBB
#define EVENTCHKINF_DISPELLED_WATER_BARRIER 0xBC
#define EVENTCHKINF_DISPELLED_SHADOW_BARRIER 0xBD
#define EVENTCHKINF_DISPELLED_FIRE_BARRIER 0xBE
#define EVENTCHKINF_DISPELLED_LIGHT_BARRIER 0xBF
#define EVENTCHKINF_WATCHED_NABOORU_KNUCKLE_INTRO_CS 0xC0
#define EVENTCHKINF_C1 0xC1
#define EVENTCHKINF_DISPELLED_TOWER_BARRIER 0xC3
#define EVENTCHKINF_C4 0xC4
#define EVENTCHKINF_C5 0xC5
#define EVENTCHKINF_KOKIRI_FOREST_DEKU_SPROUT_CS 0xC6
// Reused flag: caught by gerudo guards and watched Ganon's Tower Collapse in Ganon's Boss CS
#define EVENTCHKINF_GERUDO_FORTRESS_CAUGHT_PREVIOUSLY 0xC7
