...
// The `OCARINA_START_ONE_NOTE_LIMIT` only applies with a music staff.
// Having `OCARINA_START_WITHOUT_MUSIC_STAFF` nullifies the effect of `OCARINA_START_WITHOUT_MUSIC_STAFF` 
