...
typedef enum {
    ...
    /* 0x02 */ OCARINA_ACTION_DEMONSTRATE_MINUET, // Song demonstrations by teachers
    /* 0x03 */ OCARINA_ACTION_DEMONSTRATE_BOLERO,
    /* 0x04 */ OCARINA_ACTION_DEMONSTRATE_SERENADE,
    /* 0x05 */ OCARINA_ACTION_DEMONSTRATE_REQUIEM,
    /* 0x06 */ OCARINA_ACTION_DEMONSTRATE_NOCTURNE,
    /* 0x07 */ OCARINA_ACTION_DEMONSTRATE_PRELUDE,
    /* 0x08 */ OCARINA_ACTION_DEMONSTRATE_SARIA,
    /* 0x09 */ OCARINA_ACTION_DEMONSTRATE_EPONA,
    /* 0x0A */ OCARINA_ACTION_DEMONSTRATE_LULLABY,
    ...
    /* 0x13 */ OCARINA_ACTION_PROMPT_NOCTURNE,
    /* 0x14 */ OCARINA_ACTION_PROMPT_PRELUDE,
    /* 0x15 */ OCARINA_ACTION_PROMPT_SARIA,
    /* 0x16 */ OCARINA_ACTION_PROMPT_EPONA,
    /* 0x17 */ OCARINA_ACTION_PROMPT_LULLABY,
    ...
    /* 0x2B */ OCARINA_ACTION_SCARECROW_LONG_DEMONSTRATION,
    /* 0x2C */ OCARINA_ACTION_SCARECROW_SPAWN_RECORDING,
    /* 0x2D */ OCARINA_ACTION_SCARECROW_SPAWN_DEMONSTRATION,
...
#define OCARINA_START_EIGHT_NOTE_LIMIT 0x0000
#define OCARINA_START_WITHOUT_MUSIC_STAFF 0x4000
#define OCARINA_START_ONE_NOTE_LIMIT 0x8000

// Having `OCARINA_START_WITHOUT_MUSIC_STAFF` nullifies the effect of `OCARINA_START_ONE_NOTE_LIMIT` 
#define OCARINA_START_NO_NOTE_LIMIT (OCARINA_START_WITHOUT_MUSIC_STAFF | OCARINA_START_ONE_NOTE_LIMIT)
