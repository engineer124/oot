...
void AudioNote_SetResamplingRate(NoteSubEu* noteSubEu, f32 resamplingRateInput);
...
void Audio_ResetForAudioHeapStep1(s32 arg0);
...
void Audio_PlaySfx_AtPosWithReverb(Vec3f* pos, u16 sfxId, s8 arg2);
