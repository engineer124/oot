...
Note* AudioList_FindNoteWithPrioLessThan(AudioListItem* list, s32 limit);
...
void Audio_UpdateRiverSoundSubBgm(Vec3f* pos, u16 seqId, u16 projectedDistMax);
...
void Audio_ClearRiverSoundMainBgmPosAtPos(Vec3f* pos);
