...
typedef enum {
    /* 0x0 */ SEQ_SUB_CMD_SETUP_SET_VOLUME,
    /* 0x1 */ SEQ_SUB_CMD_SETUP_SEQ_UNQUEUE,
    /* 0x2 */ SEQ_SUB_CMD_SETUP_SEQ_START,
    /* 0x3 */ SEQ_SUB_CMD_SETUP_TEMPO_SCALE,
    /* 0x4 */ SEQ_SUB_CMD_SETUP_TEMPO_RESET,
    /* 0x5 */ SEQ_SUB_CMD_SETUP_SEQ_START_WITH_FADE,
    /* 0x6 */ SEQ_SUB_CMD_SETUP_SET_FADE_TIMER,
    /* 0x7 */ SEQ_SUB_CMD_SETUP_SET_VOLUME_IF_QUEUED,
    /* 0x8 */ SEQ_SUB_CMD_SETUP_SET_VOLUME_WITH_FADE,
    /* 0x9 */ SEQ_SUB_CMD_SETUP_SEQ_ACTIVE_CHANNELS,
 ...
 *   The scaling factor (freq) is relative to 1000. I.e. freq = 2000 with double the pitch and freq = 500 will half the pitch.
 ...
 *   Note: There are only a maximum of 8 ports indexed 0-7 (i.e. the sequence can only read 8 different io values at once)
 */
 ...
 *
 * DESCRIPTION
 *   Scale the tempo based on the current tempo on (playerIndex) by a multiplicating factor (tempoScale) over a (duration).
...
#define AudioSeqCmd_SetupRestorePlayerVolume(playerIndex, playerIndexTarget, fadeTimer)                         \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SET_VOLUME << 20) | ((u8)(playerIndex) << 24) | \
                      ((u8)(playerIndexTarget) << 16) | (u8)(fadeTimer))
/**
 * ARGS
 *   playerIndex (p)
 *
...
#define AudioSeqCmd_SetupRestartSequence(playerIndex, playerIndexTarget)                                     \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SEQ_START << 20) | ((u8)(playerIndex) << 24) | \
...
#define AudioSeqCmd_SetupPlaySequence(playerIndex, playerIndexTarget, seqId)                                  \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SEQ_START_WITH_FADE << 20) | ((u8)(playerIndex) << 24) | \
...
#define AudioSeqCmd_SetupSetFadeTimer(playerIndex, fadeTimer)                                  \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SET_FADE_TIMER << 20) | ((u8)(playerIndex) << 24) | \
                      ((u8)(fadeTimer) << 8))
...
#define AudioSeqCmd_SetupRestorePlayerVolumeIfQueued(playerIndex, playerIndexTarget, fadeTimer, numSeqRequests)             \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SET_VOLUME_IF_QUEUED << 20) | ((u8)(playerIndex) << 24) | \
                      ((u8)(playerIndexTarget) << 16) | ((u8)(fadeTimer) << 8) | (u8)(numSeqRequests))
...
#define AudioSeqCmd_SetupRestorePlayerVolumeWithScale(playerIndex, playerIndexTarget, scaleIndex, fadeTimer)                 \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SET_VOLUME_WITH_FADE << 20) | ((u8)(playerIndex) << 24) | \
                      ((u8)(playerIndexTarget) << 16) | ((u8)(scaleIndex) << 8) | (u8)(fadeTimer))
 ...
 *   bit-on (1) disables a channel, bit-off (0) reenables a channel.
 */
#define AudioSeqCmd_SetupSetDisableChannels(playerIndex, playerIndexTarget, channelMask)                                \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SEQ_ACTIVE_CHANNELS << 20) | ((u8)(playerIndex) << 24) | \
                      ((u8)(playerIndexTarget) << 16) | (u16)(channelMask))
...
#define AudioSeqCmd_SetupSetPlayerFreq(playerIndex, playerIndexTarget, duration, freq)                             \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_SET_PLAYER_FREQ << 20) | ((u8)(playerIndex) << 24) | \
                      ((u8)(playerIndexTarget) << 16) | ((u8)(duration) << 8) | (u8)(freq))
...
#define AudioSeqCmd_ResetSetupCmds(playerIndex) \
    Audio_QueueSeqCmd((SEQ_CMD_SETUP_CMD << 28) | (SEQ_SUB_CMD_SETUP_RESET_SETUP_CMDS << 20) | ((u8)(playerIndex) << 24))
...
#define AudioSeqCmd_SetSoundMode(soundMode)                                                    \
    Audio_QueueSeqCmd((SEQ_CMD_GLOBAL_CMD << 28) | (SEQ_SUB_CMD_GLOBAL_SET_SOUND_MODE << 8) | \
                      (u8)(soundMode))
...
#define AudioSeqCmd_DisableNewSequences(isDisabled)                                                   \
    Audio_QueueSeqCmd((SEQ_CMD_GLOBAL_CMD << 28) | (SEQ_SUB_CMD_GLOBAL_DISABLE_NEW_SEQUENCES << 8) | \
                      (u16)(isDisabled))
