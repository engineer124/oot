...
#define R_PLAYER_BOOT_0                          REG(19)
#define R_PLAYER_BOOT_1                          REG(30)
#define R_PLAYER_BOOT_2                          REG(32)
#define R_PLAYER_BOOT_UNUSED                     REG(34)
#define R_PLAYER_BOOT_4                          REG(35)
#define R_PLAYER_BOOT_5                          REG(36)
#define R_PLAYER_BOOT_6                          REG(37)
#define R_PLAYER_BOOT_7                          REG(38)
#define R_PLAYER_BOOT_8                          REG(43)
#define R_RUN_SPEED_LIMIT                        REG(45)
#define R_PLAYER_BOOT_10                         REG(68)
#define R_PLAYER_BOOT_11                         REG(69)
...
#define R_PLAYER_BOOT_16                         MREG(95)
...
#define R_PLAYER_BOOX_12                         IREG(66)
#define R_PLAYER_BOOX_13                         IREG(67)
#define R_PLAYER_BOOX_14                         IREG(68)
#define R_PLAYER_BOOX_15                         IREG(69)
