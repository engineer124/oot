...
beginseg
    ...
    include "build/src/code/audio_thread.o"
    include "build/src/code/audio_dcache.o"
    ...
    include "build/src/code/audio_external_general.o"
    include "build/src/code/audio_sfx_params.o"
    include "build/src/code/audio_external_sfx.o"
    include "build/src/code/audio_external_sequence.o"
