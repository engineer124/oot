...
u16 D_80119E10[SURFACE_SFX_TYPE_MAX] = {
    SFX_ID_PLAYER_WALK_GROUND - SFX_FLAG,   // SURFACE_SFX_TYPE_0
    SFX_ID_PLAYER_WALK_SAND - SFX_FLAG,     // SURFACE_SFX_TYPE_1
    SFX_ID_PLAYER_WALK_CONCRETE - SFX_FLAG, // SURFACE_SFX_TYPE_2
    SFX_ID_PLAYER_WALK_DIRT - SFX_FLAG,     // SURFACE_SFX_TYPE_3
    SFX_ID_PLAYER_WALK_WATER0 - SFX_FLAG,   // SURFACE_SFX_TYPE_4
    SFX_ID_PLAYER_WALK_WATER1 - SFX_FLAG,   // SURFACE_SFX_TYPE_5
    SFX_ID_PLAYER_WALK_WATER2 - SFX_FLAG,   // SURFACE_SFX_TYPE_6
    SFX_ID_PLAYER_WALK_MAGMA - SFX_FLAG,    // SURFACE_SFX_TYPE_7
    SFX_ID_PLAYER_WALK_GRASS - SFX_FLAG,    // SURFACE_SFX_TYPE_8
    SFX_ID_PLAYER_WALK_GLASS - SFX_FLAG,    // SURFACE_SFX_TYPE_9
    SFX_ID_PLAYER_WALK_LADDER - SFX_FLAG,   // SURFACE_SFX_TYPE_10
    SFX_ID_PLAYER_WALK_GROUND - SFX_FLAG,   // SURFACE_SFX_TYPE_11
    SFX_ID_PLAYER_WALK_ICE - SFX_FLAG,      // SURFACE_SFX_TYPE_12
    SFX_ID_PLAYER_WALK_IRON - SFX_FLAG,     // SURFACE_SFX_TYPE_13
};
...
u16 SurfaceType_GetSfxId(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId) {
    ...
    if (sfxType < 0 || sfxType >= ARRAY_COUNT(D_80119E10)) {
        return SFX_ID_PLAYER_WALK_GROUND - SFX_FLAG;
    }
