...
SfxParams sEnemyBankParams[] = {
    ...
    SFX_PARAMS(0x20, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_GOMA_UNARI
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_DODO_K_COLI2
    ...
    SFX_PARAMS(0x38, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_FALL_AIM
    SFX_PARAMS(0x30, 3, 0, 0),                       // NA_SE_EN_FALL_UP
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_FALL_CATCH
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_FANTOM_THUNDER
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_FANTOM_ATTACK
    SFX_PARAMS(0x30, 3, 0, 0),                       // NA_SE_EN_FANTOM_STICK
    SFX_PARAMS(0x30, 2, 0, 0),                       // NA_SE_EN_FANTOM_EYE
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_FANTOM_LAST
    ...
    SFX_PARAMS(0x20, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_MORIBLIN_SLIDE
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_MORIBLIN_ATTACK
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_MONBLIN_HAM_DOWN
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_MONBLIN_HAM_UP
    ...
    SFX_PARAMS(0x34, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_REDEAD_ATTACK
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_DAIOCTA_VOICE
    ...
    SFX_PARAMS(0x40, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_DAIOCTA_DEAD2
    SFX_PARAMS(0x38, 3, 0, 0),                       // NA_SE_EN_GANON_HIT_THUNDER
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_APPEAR_MS
    ...
    SFX_PARAMS(0x38, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_DAMAGE_VOICE
    ...
    SFX_PARAMS(0x38, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_YOUNG_DAMAGE
    SFX_PARAMS(0x40, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_YOUNG_DEAD
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_SHADEST_SHAKEHAND
    ...
    SFX_PARAMS(0x20, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_FLAME_MAN_SLIDE
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_FLAME_MAN_SURP
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_YOUNG_DAMAGE2
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_YOUNG_SHOOTVC
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_YOUNG_LAUGH
    SFX_PARAMS(0x30, 0, 0, 0),                       // NA_SE_EN_DUMMY442
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_TWINROBA_YOUNG_WINK
    ...
    SFX_PARAMS(0x20, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_DAIOCTA_LAND_WATER
    SFX_PARAMS(0x34, 3, 0, 0),                       // NA_SE_EN_RIVA_BIG_APPEAR
    SFX_PARAMS(0x34, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EN_MONBLIN_HAM_LAND
...
SfxParams sPlayerBankParams[] = {
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST),   // NA_SE_PL_MAGIC_WIND_WARP
...
SfxParams sItemBankParams[] = {
    SFX_PARAMS(0x30, 0, 1, SFX_FLAG_FREQ_NO_DIST), // NA_SE_IT_SWORD_IMPACT
    ...
    SFX_PARAMS(0x60, 3, 0, SFX_FLAG_FREQ_NO_DIST), // NA_SE_IT_EXPLOSION_FRAME
    SFX_PARAMS(0x60, 3, 0, SFX_FLAG_FREQ_NO_DIST), // NA_SE_IT_EXPLOSION_ICE
    SFX_PARAMS(0x60, 3, 0, SFX_FLAG_FREQ_NO_DIST), // NA_SE_IT_EXPLOSION_LIGHT
...
SfxParams sEnvBankParams[] = {
    ...
    SFX_PARAMS(0xA0, 0, 0, SFX_FLAG_VOLUME_NO_DIST | SFX_FLAG_LOWER_VOLUME_BGM), // NA_SE_SY_TIMER
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_FREQ_NO_DIST | SFX_FLAG_11),                 // NA_SE_EV_WARP_HOLE
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_FREQ_NO_DIST),                               // NA_SE_EV_LINK_WARP
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_PRIORITY_NO_DIST),                           // NA_SE_EV_FIRE_PLATE
    ...
    SFX_PARAMS(0x70, 3, 0, SFX_FLAG_PRIORITY_NO_DIST),                           // NA_SE_EV_FANTOM_WARP_S
    SFX_PARAMS(0x60, 0, 0, SFX_FLAG_FREQ_NO_DIST),                               // NA_SE_EV_FANTOM_WARP_L
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_FREQ_NO_DIST),                               // NA_SE_EV_FOUNTAIN
    ...
    SFX_PARAMS(0x30, 3, 0, SFX_FLAG_VOLUME_NO_DIST),                             // NA_SE_EV_WHITE_OUT
    SFX_PARAMS(0x30, 0, 0, 0),                                                   // NA_SE_EV_LIGHT_GATHER
    SFX_PARAMS(0x30, 0, 0, 0),                                                   // NA_SE_EV_TREE_CUT
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST | SFX_FLAG_PRIORITY_NO_DIST), // NA_SE_EV_VOLCANO
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST | SFX_FLAG_REVERB_NO_DIST | SFX_FLAG_11), // NA_SE_EV_CROWD
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EV_BUYOSHUTTER_OPEN
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EV_BUYOSHUTTER_CLOSE
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_FREQ_NO_DIST),   // NA_SE_EV_SARIA_MELODY
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_VOLUME_NO_DIST), // NA_SE_EV_GORON_WATER_DROP
...
SfxParams sSystemBankParams[] = {
    ...
    SFX_PARAMS(0xB0, 0, 0, SFX_FLAG_BLOCK_EQUAL_IMPORTANCE), // NA_SE_SY_CORRECT_CHIME
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_BLOCK_EQUAL_IMPORTANCE), // NA_SE_SY_TRE_BOX_APPEAR
...
SfxParams sOcarinaBankParams[] = {
    ...
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_BLOCK_EQUAL_IMPORTANCE), // NA_SE_OC_ABYSS
...
SfxParams sVoiceBankParams[] = {
    ...
    SFX_PARAMS(0x60, 0, 0, SFX_FLAG_BLOCK_EQUAL_IMPORTANCE), // NA_SE_VO_NAVY_ENEMY
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_BLOCK_EQUAL_IMPORTANCE), // NA_SE_VO_NAVY_HELLO
    SFX_PARAMS(0x30, 0, 0, SFX_FLAG_BLOCK_EQUAL_IMPORTANCE), // NA_SE_VO_NAVY_HEAR
    ...
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_TA_SLEEP
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_TA_SURPRISE
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_TA_CRY_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_TA_CRY_1
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_IN_CRY_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_IN_LOST
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_IN_LASH_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_IN_LASH_1
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_FR_LAUGH_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_FR_SMILE_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_NB_AGONY
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_NB_CRY_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_NB_NOTICE
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_NA_HELLO_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_NA_HELLO_1
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_NA_HELLO_2
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_RT_CRASH
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_RT_DISCOVER
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_RT_FALL
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_RT_LAUGH_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_RT_LIFT
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_RT_THROW
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_RT_UNBALLANCE
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_ST_DAMAGE
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_ST_ATTACK
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z0_HURRY
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z0_MEET
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z0_QUESTION
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z0_SIGH_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z0_SMILE_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z0_SURPRISE
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z0_THROW
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_SK_CRY_0
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_SK_CRY_1
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_SK_CRASH
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_SK_LAUGH
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_SK_SHOUT
    SFX_PARAMS(0x30, 3, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z1_CRY_0
    SFX_PARAMS(0x30, 3, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z1_CRY_1
    SFX_PARAMS(0x30, 3, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z1_OPENDOOR
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z1_SURPRISE
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_Z1_PAIN
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_KZ_MOVE
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_NB_LAUGH
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_IN_LAUGH
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_DUMMY_0x7d
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_DUMMY_0x7e
    SFX_PARAMS(0x30, 1, 1, SFX_FLAG_FREQ_NO_DIST),           // NA_SE_VO_DUMMY_0x7f
};
