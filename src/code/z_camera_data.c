...
CameraModeValue D_8011A3A0[] = {
    ...
    { 60, 7 },  // fovTarget
    { 60, 8 },  // atLERPScaleMax
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | NORM1_FLG_2 | NORM1_FLG_1, 9 },
};
...
CameraModeValue D_8011A3C8[] = {
    ...
    { 45, 7 },  // fovTarget
    { 50, 8 },  // unk_14
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | PARA1_FLG_8 | PARA1_FLG_2, 9 },
    { -40, 11 }, // unk_18
    { 20, 12 }   // unk_1C
};
...
CameraModeValue D_8011A3F4[] = {
    ...
    { 45, 7 },  // unk_20
    { 50, 8 },  // unk_24
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | KEEP1_FLG_1, 9 },
    { -50, 11 }, // unk_28
    { 30, 12 },  // unk_2C
};
...
CameraModeValue D_8011A428[] = {
    ...
    { 50, 8 },  // atLERPScaleMax
    { 10, 4 },  // initTimer
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(5), 9 },
};
...
CameraModeValue D_8011A488[] = {
    ...
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0), 9 },
};
...
CameraModeValue D_8011A580[] = {
    ...
    { 60, 7 },  // fovTarget
    { 40, 8 },  // atLERPStepScale
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | JUMP2_FLG_4 | JUMP2_FLG_2, 9 },
};
...
CameraModeValue D_8011A61C[] = {
    ...
    { 80, 7 },  // fovTarget
    { 20, 8 },  // atLERPTarget
    { CAM_SHRINKWINVAL_PREV | CAM_IFACE_ALPHA(0), 9 },
};
...
CameraModeValue D_8011A638[] = {
    ...
    { 60, 7 },  // fovTarget
    { 5, 8 },   // atLERPScaleMax
    { CAM_SHRINKWINVAL_PREV | CAM_IFACE_ALPHA(0) | NORM1_FLG_2 | NORM1_FLG_1, 9 },
};
...
CameraModeValue D_8011A660[] = {
    ...
    { 70, 7 },  // fovTarget
    { 30, 8 },  // unk_14
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | PARA1_FLG_40 | PARA1_FLG_20 | PARA1_FLG_8 | PARA1_FLG_2, 9 },
    { -20, 11 }, // unk_18
    { 30, 12 },  // unk_1C
};
...
CameraModeValue sSetNorm1ModeParaVals[] = {
    ...
    { 45, 7 },  // fovTarget
    { 50, 8 },  // unk_14
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | PARA1_FLG_2, 9 },
    { -40, 11 }, // unk_18
    { 20, 12 },  // unk_1C
};
...
CameraModeValue sSetNorm3ModeNormVals[] = {
    ...
    { 60, 7 },  // fovTarget
    { 100, 8 }, // unk_1C
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | JUMP3_FLG_4, 9 },
};
...
CameraModeValue sSetNorm3ModeBoomVals[] = {
    ...
    { 60, 7 },  // fovTarget
    { 40, 8 },  // unk_1C
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | JUMP3_FLG_4 | JUMP3_FLG_1, 9 },
};
...
CameraModeValue sSetHrse0ModeNormVals[] = {
    ...
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(6), 9 },
};
...
CameraModeValue sSetHrse0ModeParaVals[] = {
    ...
    { 45, 7 },  // fovTarget
    { 100, 8 }, // maxAtLERPScale
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(6), 9 },
};
...
CameraModeValue D_8011ACF8[] = {
    ...
    { 45, 7 },  // unk_20
    { 50, 8 },  // unk_24
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(6) | KEEP1_FLG_1, 9 },
    { -60, 11 }, // unk_28
    { 20, 12 },  // unk_2C
};
...
CameraModeValue D_8011AD5C[] = {
    ...
    { 60, 7 },  // fovTarget
    { 60, 8 },  // atLERPScaleMax
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | NORM1_FLG_1, 9 },
};
...
CameraModeValue D_8011AF14[] = {
    ...
    { 60, 7 },  // fovTarget
    { 80, 8 },  // atLERPScaleMax
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | NORM1_FLG_80 | NORM1_FLG_2 | NORM1_FLG_1, 9 },
};
...
CameraModeValue D_8011AF3C[] = {
    ...
    { 45, 7 },  // fov
    { 50, 8 },  // atLERPScaleOnGround (PCT)
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | BATT1_FLG_80 | BATT1_FLG_2, 9 },
    { -40, 11 }, // yOffsetOffGround (PCT)
    { 20, 12 },  // atLERPScaleOffGround (PCT)
};
...
CameraModeValue D_8011B12C[] = {
    ...
    { 60, 7 },  // unk_14
    { 50, 8 },  // unk_18
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | NORM2_FLG_80, 9 },
};
...
CameraModeValue sSetCirc0ModeNormVals[] = {
    ...
    { 80, 5 },  // posStepScale
    { 60, 7 },  // fov
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | FIXD2_FLG_1, 9 },
};
...
CameraModeValue sSetCirc2ModeNormVals[] = {
    ...
    { -40, 0 }, // yOffset
    { 60, 7 },  // fov
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(0xF), 9 },
};
...
CameraModeValue D_8011B1F8[] = {
    ...
    { 80, 5 },  // followSpeed
    { 60, 7 },  // fov
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | FIXD4_FLG_4, 9 },
};
...
CameraModeValue sSetDoor0ModeNormVals[] = {
    ...
    { -40, 0 }, // yOffset
    { 60, 7 },  // fov
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(2), 9 },
};
...
CameraModeValue sSetDoorCModeNormVals[] = {
    ...
    { -5, 0 }, // yOffset
    { 60, 7 }, // unk_04 (unused)
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(2) | SPEC9_FLG_2, 9 },
};
...
CameraModeValue sSetDoorCModeParaVals[] = {
    ...
    { -5, 0 }, // yOffset
    { 60, 7 }, // unk_04 (unused)
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(2) | SPEC9_FLG_8 | SPEC9_FLG_2, 9 },
};
...
CameraModeValue D_8011B270[] = {
    /* CAM_FUNC_UNIQ0 */
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | UNIQ0_FLG_1, 9 },
};

CameraModeValue sSetFree0ModeNormVals[] = {
    /* CAM_FUNC_UNIQ6 */
    { CAM_SHRINKWINVAL_PREV | CAM_IFACE_ALPHA(0xF), 9 },
};

CameraModeValue sSetFree1ModeNormVals[] = {
    /* CAM_FUNC_UNIQ6  */
    { CAM_SHRINKWINVAL_PREV | CAM_IFACE_ALPHA(0xF) | UNIQ6_FLG_1, 9 },
};
...
CameraModeValue D_8011B290[] = {
    ...
    { 60, 1 },  // distTarget
    { 60, 7 },  // fovTarget
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | UNIQ2_FLG_2, 9 },
};
...
CameraModeValue D_8011B2A0[] = {
    ...
    { 45, 1 },  // distTarget
    { 100, 7 }, // fovTarget
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | UNIQ2_FLG_1, 9 },
};
...
CameraModeValue sSetMori1ModeNormVals[] = {
    ...
    { 70, 7 },   // fovTarget
    { 30, 8 },   // unk_14
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | PARA1_FLG_8 | PARA1_FLG_4, 9 },
    { -50, 11 }, // unk_18
    { 20, 12 },  // unk_1C
};
...
CameraModeValue D_8011B2E0[] = {
    /* CAM_FUNC_PARA3 */
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(5) | PARA3_FLG_1, 9 },
};
...
CameraModeValue sSetDemo3ModeNormVals[] = {
    /* CAM_FUNC_DEMO9 */
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(2) | DEMO9_FLG_10 | DEMO9_FLG_2, 9 },
};
...
CameraModeValue D_8011B2F4[] = {
    ...
    { 70, 7 },  // fovTarget
    { 40, 8 },  // atLERPScaleMax
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | NORM1_FLG_2, 9 },
};
...
CameraModeValue D_8011B3A0[] = {
    ...
    { 70, 7 },  // fovTarget
    { 30, 8 },  // atLERPScaleMax
    { CAM_SHRINKWINVAL_PREV | CAM_IFACE_ALPHA(0) | NORM1_FLG_2, 9 },
};
...
CameraModeValue sSetScn0ModeNormVals[] = {
    ...
    { -30, 0 }, // yOffset
    { 60, 7 },  // unk_04 (unused)
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(1) | SPEC9_FLG_8 | SPEC9_FLG_2, 9 },
};
...
CameraModeValue D_8011B4A8[] = {
    ...
    { 150, 1 }, // distTarget
    { 60, 7 },  // fovTarget
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(2) | UNIQ2_FLG_10, 9 },
};
...
CameraModeValue D_8011B4B8[] = {
    ...
    { 60, 7 },  // fovTarget
    { 40, 8 },  // atLERPScaleMax
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0) | NORM1_FLG_10 | NORM1_FLG_2, 9 },
};
...
CameraModeValue D_8011B560[] = {
    ...
    { 70, 7 },  // fovTarget
    { 80, 8 },  // unk_14
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0) | PARA1_FLG_10 | PARA1_FLG_8 | PARA1_FLG_2, 9 },
    { -40, 11 }, // unk_18
    { 40, 12 },  // unk_1C
};
...
CameraModeValue D_8011B784[] = {
    ...
    { 55, 7 },  // fovTarget
    { 60, 8 },  // atLERPScaleMax
    { CAM_IFACE_ALPHA(0xF) | CAM_IFACE_ALPHA(0) | NORM1_FLG_2, 9 },
};
...
CameraModeValue D_8011B7AC[] = {
    ...
    { 45, 7 },  // fovTarget
    { 50, 8 },  // unk_14
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0xF) | PARA1_FLG_8 | PARA1_FLG_2, 9 },
    { -40, 11 }, // unk_18
    { 20, 12 },  // unk_1C
};
...
CameraModeValue D_8011B7D8[] = {
    ...
    { 55, 7 },  // fov
    { 80, 8 },  // atLERPScaleOnGround (PCT)
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0xF) | BATT1_FLG_2, 9 },
    { -40, 11 }, // yOffsetOffGround (PCT)
    { 25, 12 },  // atLERPScaleOffGround (PCT)
};
...
CameraModeValue D_8011B808[] = {
    ...
    { 50, 8 },  // atLERPScaleMax
    { 10, 4 },  // initTimer
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(0xF) | KEEP3_FLG_20, 9 },
};
...
CameraModeValue D_8011B838[] = {
    ...
    { 0, 21 }, // atOffset.z
    { 45, 7 }, // fovTarget
    { CAM_SHRINKWINVAL_NONE | CAM_IFACE_ALPHA(0xF), 9 },
};
...
CameraModeValue D_8011B8B8[] = {
    ...
    { 45, 7 },   // fovTarget
    { 10, 8 },   // atLERPScaleMax
    { CAM_SHRINKWINVAL_MEDIUM | CAM_IFACE_ALPHA(0xF), 9 },
};
...
CameraModeValue D_8011BB24[] = {
    ...
    { 50, 8 },  // atLERPScaleMax
    { 10, 4 },  // initTimer
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(5) | KEEP3_FLG_20, 9 },
};
...
CameraModeValue D_8011BB54[] = {
    ...
    { 50, 8 },  // atLERPScaleMax
    { 10, 4 },  // initTimer
    { CAM_SHRINKWINVAL_LARGE | CAM_IFACE_ALPHA(5) | KEEP3_FLG_80 | KEEP3_FLG_20, 9 },
};
