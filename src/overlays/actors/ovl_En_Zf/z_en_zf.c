...
void EnZf_DropIn(EnZf* this, PlayState* play) {
    if (this->unk_3F0 == 1) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIZA_CRY);
        this->actor.flags |= ACTOR_FLAG_0;
    ...
    if ((this->actor.bgCheckFlags & (BGCHECKFLAG_GROUND | BGCHECKFLAG_GROUND_TOUCH)) && (this->hopAnimIndex != 0)) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIZA_ONGND);
...
void EnZf_SetupJumpForward(EnZf* this) {
    ...
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIZA_JUMP);
...
void EnZf_Slash(EnZf* this, PlayState* play) {
    ...
    if ((s32)this->skelAnime.curFrame == 10) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIZA_ATTACK);
    }
...
void EnZf_SetupDamaged(EnZf* this) {
    ...
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIZA_DAMAGE);
...
void EnZf_SetupDie(EnZf* this) {
    ...
    D_80B4A1B0 = 0;
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIZA_DEAD);
