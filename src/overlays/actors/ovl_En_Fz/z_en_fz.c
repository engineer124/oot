            ...
            if (this->actor.colChkInfo.damageEffect != 2) {
                if (this->actor.colChkInfo.damageEffect == 0xF) {
                    ...
                    if (this->actor.colChkInfo.health) {
                        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_FREEZAD_DAMAGE);
                        ...
                        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_FREEZAD_DEAD);
...
void EnFz_BlowSmoke(EnFz* this, GlobalContext* globalCtx) {
    ...
    if (this->timer == 0) {
        ...
        isTimerMod8 = false;
        primAlpha = 150;
        Actor_PlaySfxAtPos3(&this->actor, NA_SE_EN_FREEZAD_BREATH - SFX_FLAG);
