...
void func_809F709C(EnDodojr* this) {
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DODO_M_DEAD);
    this->actor.flags &= ~ACTOR_FLAG_0;
    func_809F6A20(this);
    ...
    if (!(this->actor.xzDistToPlayer >= 320.0f)) {
        ...
        if (!(dist >= 40.0f)) {
            Animation_Change(&this->skelAnime, &object_dodojr_Anim_000860, 1.8f, 0.0f, lastFrame, ANIMMODE_LOOP_INTERP,
                             -10.0f);
            Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DODO_M_UP);
...
void func_809F758C(EnDodojr* this, GlobalContext* globalCtx) {
    ...
    if (DECR(this->timer4) == 0) {
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DODO_M_MOVE);
        this->timer4 = 5;
    }
    ...
    if (func_809F706C(this) != 0) {
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DODO_M_CRY);
        func_809F6B38(this);
        this->actionFunc = func_809F799C;
    }

    if (this->actor.bgCheckFlags & 8) {
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DODO_M_DOWN);
        func_809F6BBC(this);
