    ...
    if (player->stateFlags1 & PLAYER_STATE1_22 &&
        ...
        if (fabsf(vec.x) < 30.0f && fabsf(vec.y) < 70.0f && vec.z > 100.0f && vec.z <= this->beamDist) {
            ...
            if (sBeamDivertTimer == 0) {
                ...
                this->timers[0] = 10;
                Lib_PlaySfx(SFX_ID_ITEM_SHIELD_REFLECT_MG2);
            }
            ...
            case 0:
                if (this->timers[0] != 0) {
                    ...
                    if (beamReflection == 1) {
                        ...
                        this->beamShootState = 1;
                        Lib_PlaySfx_AtPos(&player->actor.projectedPos, SFX_ID_ITEM_SHIELD_REFLECT_MG);
    ...
    switch (this->csState1) {
        ...
        case 2:
            ...
            if (this->timers[1] == 8) {
                ...
                Lib_PlaySfx(SFX_ID_ENEMY_TWINROBA_YOUNG_WINK);
            }
            if (this->timers[2] == 4) {
                sEnvType = 0;
...
void BossTw_TwinrovaIntroCS(BossTw* this, PlayState* play) {
    ...
    if (this->csSfxTimer > 220 && this->csSfxTimer < 630) {
        Lib_PlaySfx(SFX_ID_ENEMY_TWINROBA_UNARI - SFX_FLAG);
    }

    if (this->csSfxTimer == 180) {
        Lib_PlaySfx_AtPos(&D_8094A7D0, SFX_ID_ENEMY_TWINROBA_LAUGH);
        Lib_PlaySfx_AtPos(&D_8094A7D0, SFX_ID_ENEMY_TWINROBA_LAUGH2);
    ...
    switch (this->csState2) {
        ...
        case 1:
            ...
            if (this->work[CS_TIMER_1] == 180) {
                Lib_PlaySfx(SFX_ID_ENEMY_TWINROBA_APPEAR_MS);
            }
...
void BossTw_DeathCSMsgSfx(BossTw* this, PlayState* play) {
    ...
    if (this->work[CS_TIMER_2] > 440 && this->work[CS_TIMER_2] < 860) {
        Lib_PlaySfx(SFX_ID_ENEMY_TWINROBA_FIGHT - SFX_FLAG);
    }
        ...
        case 0:
            ...
            if (this->work[CS_TIMER_1] >= 55) {
                ...
                if (this->work[CS_TIMER_1] == 135) {
                    ...
                    Lib_PlaySfx(SFX_ID_ENEMY_TWINROBA_TRANSFORM);
                    for (i = 0; i < 100; i++) {
...
void BossTw_TwinrovaUpdate(Actor* thisx, PlayState* play2) {
    ...
    if (sFreezeState == 1) {
        ...
        Lib_PlaySfx_AtPos(&player->actor.projectedPos, SFX_ID_VOICE_LI_FREEZE);
...
void BossTw_ShieldChargeDraw(BossTw* this, PlayState* play) {
    ...
    if (temp_t0 == 1) {
        Lib_PlaySfx(SFX_ID_ITEM_SHIELD_CHARGE_LV1 & ~SFX_FLAG);
    } else if (temp_t0 == 2) {
        Lib_PlaySfx(SFX_ID_ITEM_SHIELD_CHARGE_LV2 & ~SFX_FLAG);
    } else if (temp_t0 == 3) {
        Lib_PlaySfx(SFX_ID_ITEM_SHIELD_CHARGE_LV3 & ~SFX_FLAG);
    }
