    ...
    if (player->stateFlags1 & PLAYER_STATE1_22 &&
        ...
        if (fabsf(vec.x) < 30.0f && fabsf(vec.y) < 70.0f && vec.z > 100.0f && vec.z <= this->beamDist) {
            ...
            if (sBeamDivertTimer == 0) {
                ...
                this->timers[0] = 10;
                Lib_PlaySfx(NA_SE_IT_SHIELD_REFLECT_MG2);
            }
    ...
    if (this->timers[1] != 0) {
        ...
        switch (this->beamShootState) {
            ...
            case 0:
                if (this->timers[0] != 0) {
                    ...
                    if (beamReflection == 1) {
                        ...
                        this->beamShootState = 1;
                        Lib_PlaySfx_AtPos(&player->actor.projectedPos, NA_SE_IT_SHIELD_REFLECT_MG);
                ...
                if (this->actor.params == TW_KOUME) {
                    AudioSfx_PlaySfx(NA_SE_EN_TWINROBA_SHOOT_FIRE - SFX_FLAG, &this->unk_54C, 4,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                } else {
                    AudioSfx_PlaySfx(NA_SE_EN_TWINROBA_SHOOT_FREEZE - SFX_FLAG, &this->unk_54C, 4,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                }
                break;
            ...
            case 1:
                ...
                if (this->actor.params == TW_KOUME) {
                    AudioSfx_PlaySfx(NA_SE_EN_TWINROBA_SHOOT_FIRE - SFX_FLAG, &this->unk_558, 4,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                    AudioSfx_PlaySfx(NA_SE_EN_TWINROBA_REFL_FIRE - SFX_FLAG, &this->unk_558, 4,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                } else {
                    AudioSfx_PlaySfx(NA_SE_EN_TWINROBA_SHOOT_FREEZE - SFX_FLAG, &this->unk_558, 4,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                    AudioSfx_PlaySfx(NA_SE_EN_TWINROBA_REFL_FREEZE - SFX_FLAG, &this->unk_558, 4,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                }
                break;
        }
    ...
    switch (this->csState1) {
        ...
        case 2:
            ...
            if (this->timers[1] == 8) {
                ...
                Lib_PlaySfx(NA_SE_EN_TWINROBA_YOUNG_WINK);
            }
            if (this->timers[2] == 4) {
                sEnvType = 0;
...
void BossTw_TwinrovaIntroCS(BossTw* this, PlayState* play) {
    ...
    if (this->csSfxTimer > 220 && this->csSfxTimer < 630) {
        Lib_PlaySfx(NA_SE_EN_TWINROBA_UNARI - SFX_FLAG);
    }
    ...
    switch (this->csState2) {
        ...
        case 1:
            ...
            if (this->work[CS_TIMER_1] == 180) {
                Lib_PlaySfx(NA_SE_EN_TWINROBA_APPEAR_MS);
            }
...
void BossTw_DeathCSMsgSfx(BossTw* this, PlayState* play) {
    ...
    if (this->work[CS_TIMER_2] > 440 && this->work[CS_TIMER_2] < 860) {
        Lib_PlaySfx(NA_SE_EN_TWINROBA_FIGHT - SFX_FLAG);
    }
...
void BossTw_ShieldChargeDraw(BossTw* this, PlayState* play) {
    ...
    if (temp_t0 == 1) {
        Lib_PlaySfx(NA_SE_IT_SHIELD_CHARGE_LV1 & ~SFX_FLAG);
    } else if (temp_t0 == 2) {
        Lib_PlaySfx(NA_SE_IT_SHIELD_CHARGE_LV2 & ~SFX_FLAG);
    } else if (temp_t0 == 3) {
        Lib_PlaySfx(NA_SE_IT_SHIELD_CHARGE_LV3 & ~SFX_FLAG);
    }
