...
void func_809FE798(EnDu* this, PlayState* play) {
    if (DECR(this->unk_1E2) != 0) {
        switch (this->unk_1E2) {
            case 0x50:
                Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_CHAIN_KEY_UNLOCK_B);
                break;
            case 0x3C:
                Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_SLIDE_DOOR_OPEN);
                break;
            case 0xF:
                Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_SLIDE_DOOR_CLOSE);
                break;
            case 5:
                Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_STONE_BOUND);
                break;
        }
