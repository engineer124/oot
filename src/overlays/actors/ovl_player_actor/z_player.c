...
int Player_TryZTargeting(Player* this) {
...
void Player_Action_80840450(Player* this, PlayState* play) {
    ...
    if (!Player_TryActionChangeList(play, this, sActionChangeList1, true)) {
        if (!Player_TryEnemyLockOn(this) &&
            (!Player_IsZParallelOrLockOnFriend(this) || (func_80834B5C != this->upperActionFunc))) {
...
void Player_Action_8084B1D8(Player* this, PlayState* play) {
    ...
    if ((this->csAction != PLAYER_CSACTION_NONE) || (this->unk_6AD == 0) || (this->unk_6AD >= 4) ||
        Player_TryEnemyLockOn(this) || (this->targetActor != NULL) || (func_8083AD4C(play, this) == CAM_MODE_NORMAL) ||
        (((this->unk_6AD == 2) &&
