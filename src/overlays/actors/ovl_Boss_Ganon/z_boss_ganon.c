...
void BossGanon_IntroCutscene(BossGanon* this, PlayState* play) {
    ...
    switch (this->csState) {
        ...
        case 6:
            ...
            Lib_PlaySfx(NA_SE_EV_TRIFORCE_MARK);
            play->envCtx.lightBlend = 0.0f;
            FALLTHROUGH;
        case 7:
            this->envLightMode = 6;
...
void BossGanon_DeathAndTowerCutscene(BossGanon* this, PlayState* play) {
    ...
    switch (this->csState) {
        ...
        case 8:
            ...
            Lib_PlaySfx(NA_SE_EV_EARTHQUAKE - SFX_FLAG);
...
void BossGanon_Wait(BossGanon* this, PlayState* play) {
    ...
    Lib_PlaySfx_AtPos(&this->actor.projectedPos, NA_SE_EN_FANTOM_FLOAT - SFX_FLAG);
}
            ...
            case 0:
                ...
                if ((this->collider.base.acFlags & AC_HIT) || hitWithBottle) {
                    ...
                    if ((hitWithBottle == false) && (acHitInfo->toucher.dmgFlags & DMG_SHIELD)) {
                        spBA = 2;
                        AudioSfx_PlaySfx(NA_SE_IT_SHIELD_REFLECT_MG, &player->actor.projectedPos, 4,
                        ...
                        this->unk_1A4++;
                        this->timers[1] = 2;
                        AudioSfx_PlaySfx(NA_SE_IT_SWORD_REFLECT_MG, &player->actor.projectedPos, 4,
                                         &gSfxDefaultFreqAndVolScale, &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
    ...
    if (this->unk_1C2 == 0) {
        ...
        if (sqrtf(SQ(xDiff) + SQ(zDiff) + SQ(yDiff)) < 40.0f) {
            ...
            if (this->actor.params == 0xC8) {
                Lib_PlaySfx(NA_SE_EN_GANON_DAMAGE2);
                Lib_PlaySfx(NA_SE_EN_GANON_DD_THUNDER);
    ...
    for (i = 0; i < BOSSGANON_EFFECT_COUNT; i++, eff++) {
        if (eff->type != GDF_EFF_NONE) {
            ...
            if (eff->type == GDF_EFF_WINDOW_SHARD) {
                ...
                if (i == 0) {
                    Lib_PlaySfx(NA_SE_EN_GANON_WAVE_GND - SFX_FLAG);
                }
