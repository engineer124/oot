...
void BossGanon_IntroCutscene(BossGanon* this, GlobalContext* globalCtx) {
    ...
    switch (this->csState) {
        ...
        case 6:
            ...
            Lib_PlaySfx1(NA_SE_EV_TRIFORCE_MARK);
            globalCtx->envCtx.unk_D8 = 0.0f;
            // fallthrough
        case 7:
            this->envLightMode = 6;
        ...
        case 17: // turns around
            ...
            if (this->csTimer > 10) {
                ...
                if (this->csTimer == 57) {
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EV_GANON_MANTLE);
                }
        ...
        case 19: // show triforce
            ...
            if ((this->csTimer > 80) && (Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_NONE)) {
                ...
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_DARKWAVE);
            }
            break;
        ...
        case 20: // zoom cam out
            ...
            if (this->csTimer > 20) {
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_DARKWAVE_M - SFX_FLAG);
            }
        ...
        case 22: // start floating, show title card, start fight
            ...
            if (this->csTimer >= 20) {
                ...
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_FLOAT - SFX_FLAG);
    ...
    switch (this->csState) {
        ...
        case 2:
            ...
            if ((this->unk_1A2 % 32) == 0) {
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_BREATH);
            }
            break;
        ...
        case 3:
            ...
            if ((this->fwork[GDF_FWORK_1] > 100.0f) && (this->csTimer > 100) &&
                ...
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_TOKETU);
            } else {
        ...
        case 5:
            ...
            if ((this->csTimer > 70) && (Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_NONE)) {
                ...
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_CASBREAK);
            }
            break;
        ...
        case 8:
            ...
            Lib_PlaySfx1(NA_SE_EV_EARTHQUAKE - SFX_FLAG);

        skip_cam_and_quake:
            this->envLightMode = 15;
            Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_BODY_SPARK - SFX_FLAG);
        ...
        case 101:
            ...
            if (this->csTimer > 40) {
                ...
                if (this->csTimer == 160) {
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_PL_BOUND_NOWEAPON);
                }

                if (this->csTimer == 187) {
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_PL_BODY_HIT);
                }
        ...
        case 103:
            Actor_PlaySfxAtPos1(&sZelda->actor, NA_SE_EV_DOWN_TO_GROUND - SFX_FLAG);
...
void BossGanon_PoundFloor(BossGanon* this, GlobalContext* globalCtx) {
    ...
    switch (this->unk_1C2) {
        case 0:
            ...
            if (this->timers[0] == 5) {
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_HIT_GND);
            }
        ...
        case 1:
            ...
            if (this->actor.world.pos.y < 60.0f) {
                ...
                this->unk_19C = 35;
                this->unk_19E = 0;
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_HIT_GND_IMP);
...
void BossGanon_ChargeBigMagic(BossGanon* this, GlobalContext* globalCtx) {
    ...
    switch (this->unk_1C2) {
        ...
        case 2:
            this->envLightMode = 2;
            Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_CHARGE_MASIC - SFX_FLAG);
        ...
        case 4:
            ...
            if (Animation_OnFrame(&this->skelAnime, 5.0f)) {
                ...
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_BIGMASIC);
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_THROW_BIG);
            }
...
void BossGanon_Wait(BossGanon* this, GlobalContext* globalCtx) {
    ...
    Lib_PlaySfxAtPos(&this->actor.projectedPos, NA_SE_EN_FANTOM_FLOAT - SFX_FLAG);
}
...
void BossGanon_ChargeLightBall(BossGanon* this, GlobalContext* globalCtx) {
    ...
    if (this->timers[0] == 17) {
        ...
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_SPARK);
    }
    ...
    switch (this->unk_1C2) {
        case 0:
            ...
            if (Animation_OnFrame(&this->skelAnime, 11.0f)) {
                this->unk_25C = 1;
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_THROW);
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_THROW_MASIC);
...
void BossGanon_HitByLightBall(BossGanon* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_1C2 == 0) {
        ...
        if (this->timers[0] == 0) {
            ...
            sCape->attachShouldersTimer = 18.0f;
            Actor_PlaySfxAtPos1(&this->actor, NA_SE_EV_GANON_MANTLE);
            Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_RESTORE);
            this->timers[2] = 130;
        }
    } else {
        if (Animation_OnFrame(&this->skelAnime, 7.0f)) {
            ...
            Actor_PlaySfxAtPos1(&this->actor, NA_SE_PL_WALK_WATER2);
        }
...
void BossGanon_Vulnerable(BossGanon* this, GlobalContext* globalCtx) {
    ...
    switch (this->unk_1C2) {
        ...
        case 4:
            if (Animation_OnFrame(&this->skelAnime, 5.0f)) {
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_DOWN);
            }
    ...
    if (this->collider.base.acFlags & 2) {
        ...
        if ((this->actionFunc == BossGanon_HitByLightBall) || (this->actionFunc == BossGanon_ChargeBigMagic)) {
            if (acHitInfo->toucher.dmgFlags & 0x2000) {
                ...
                this->timers[2] = 0;
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_DAMAGE1);
                this->unk_1A6 = 15;
            }
            ...
            if (!(acHitInfo->toucher.dmgFlags & 0x80)) {
                ...
                if ((s8)this->actor.colChkInfo.health <= 0) {
                    ...
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_DEAD);
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_DD_THUNDER);
                    Lib_PlaySfxAtPos(&sZeroVec, NA_SE_EN_LAST_DAMAGE);
                    Audio_QueueSeqCmd(0x100100FF);
                    this->screenFlashTimer = 4;
                } else {
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_DAMAGE2);
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_CUTBODY);
            ...
            Actor_PlaySfxAtPos1(&this->actor, 0);
...
void BossGanon_Update(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    if (this->timers[2] == 1) {
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_LAUGH);
    }
    ...
    if ((this->unk_2E6 != 0) || (this->unk_2E8 != 0)) {
        ...
        if (this->unk_2E8 != 0) {
            Lib_PlaySfxAtPos(&player->actor.projectedPos, NA_SE_PL_SPARK - SFX_FLAG);
...
void BossGanon_LightBall_Update(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    if (this->unk_1A8 != 0) {
        ...
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_FIRE - SFX_FLAG);
        ...
        switch (this->unk_1C2) {
            ...
            case 2:
                if (this->timers[0] == 1) {
                    ...
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GANON_AT_RETURN);
                    this->unk_1C2 = 0;
                    break;
                }
                // fallthrough
    ...
    if (this->unk_1C2 == 0) {
        ...
        if (sqrtf(SQ(xDiff) + SQ(zDiff) + SQ(yDiff)) < 40.0f) {
            ...
            if (this->actor.params == 0xC8) {
                Lib_PlaySfx1(NA_SE_EN_GANON_DAMAGE2);
                Lib_PlaySfx1(NA_SE_EN_GANON_DD_THUNDER);
    ...
    for (i = 0; i < ARRAY_COUNT(sEffectBuf); i++, eff++) {
        if (eff->type != GDF_EFF_NONE) {
            ...
            if (eff->type == GDF_EFF_WINDOW_SHARD) {
                ...
                if (i == 0) {
                    Lib_PlaySfx1(NA_SE_EN_GANON_WAVE_GND - SFX_FLAG);
                }
