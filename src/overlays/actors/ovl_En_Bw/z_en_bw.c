...
void func_809CEA24(EnBw* this, PlayState* play) {
    ...
    if (this->unk_232 == 0) {
        ...
        if (ABS(sp58) > ABS(sp5C)) {
            Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BUBLEWALK_WALK);
            this->unk_232 = 0;
        }
    }
...
void func_809CF72C(EnBw* this) {
    ...
    this->unk_224 = 0xBB8;
    this->actor.speedXZ = 0.0f;
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BUBLEWALK_AIM);
...
void func_809CFBA8(EnBw* this) {
    ...
    this->unk_224 = 0xBB8;
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BUBLEWALK_REVERSE);
...
void func_809D00F4(EnBw* this) {
    ...
    this->actor.speedXZ = 0.0f;
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BUBLEWALK_DEAD);
    ...
    if ((this->actor.bgCheckFlags & BGCHECKFLAG_CEILING) && (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)) {
        ...
        if (this->collider2.base.acFlags & AC_HIT) {
            ...
            if (((this->unk_221 == 1) || (this->unk_221 == 4)) && (this->actor.colChkInfo.health == 0)) {
                ...
                Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BUBLEWALK_DAMAGE);
                Actor_SetColorFilter(&this->actor, 0x4000, 0xFF, 0, 8);
                if (this->unk_220 != 5) {
                    func_809D01CC(this);
                }
