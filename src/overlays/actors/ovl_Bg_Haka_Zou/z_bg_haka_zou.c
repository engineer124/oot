...
void func_80883000(BgHakaZou* this, PlayState* play) {
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if (this->dyna.actor.params == STA_GIANT_BIRD_STATUE) {
            ...
            this->timer = 1;
            Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_EXPLOSION);
            this->actionFunc = func_80883104;
        } else {
            func_80882CC4(this, play);
            this->timer = 1;
            Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_WALL_BROKEN);
            this->actionFunc = func_80883104;
        }
    } else {
...
void func_80883144(BgHakaZou* this, PlayState* play) {
    ...
    if (!(this->timer % 4)) {
        ...
        Actor_PlaySfx(&this->dyna.actor, SFX_ID_ITEM_BOMB_EXPLOSION);
    }
