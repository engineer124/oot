...
void BgSpot12Gate_InitDynaPoly(BgSpot12Gate* this, PlayState* play, CollisionHeader* collision, s32 transformFlags) {
    s32 pad;
    CollisionHeader* colHeader = NULL;

    DYNAPOLY_INIT_AND_SET(&this->dyna, play, collision, colHeader, transformFlags, "../z_bg_spot12_gate.c", 145);
}
