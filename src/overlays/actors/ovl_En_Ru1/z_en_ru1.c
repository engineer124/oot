...
void func_80AEBAFC(EnRu1* this) {
    if (this->unk_298 == 0) {
        func_80078914(&this->actor.projectedPos, SFX_ID_ENVIRONMENT_DIVE_INTO_WATER);
        this->unk_298 = 1;
    }
}
...
void func_80AEBB3C(EnRu1* this) {
    if (Animation_OnFrame(&this->skelAnime, 5.0f)) {
        func_80078914(&this->actor.projectedPos, SFX_ID_PLAYER_FACE_UP);
    }
}
...
void func_80AEBB78(EnRu1* this) {
    ...
    if (Animation_OnFrame(skelAnime, 4.0f) || Animation_OnFrame(skelAnime, 13.0f) ||
        ...
        func_80078914(&this->actor.projectedPos, SFX_ID_PLAYER_SWIM);
    }
}

void func_80AEBBF4(EnRu1* this) {
    if (Animation_OnFrame(&this->skelAnime, 8.0f)) {
        func_80078914(&this->actor.projectedPos, SFX_ID_PLAYER_SUBMERGE);
    }
}
...
void func_80AEBC84(EnRu1* this, PlayState* play) {
    if (play->csCtx.frames == 0x82) {
        func_80078914(&this->actor.projectedPos, SFX_ID_VOICE_RT_LAUGH_0);
    }
}
...
void func_80AEC650(EnRu1* this) {
    ...
    if (this->unk_280 == 0) {
        if (Animation_OnFrame(&this->skelAnime, 2.0f) || Animation_OnFrame(&this->skelAnime, 7.0f)) {
            func_80078914(&this->actor.projectedPos, SFX_ID_PLAYER_WALK_DIRT);
        }
    }
}

void func_80AEC6B0(EnRu1* this) {
    func_80078914(&this->actor.projectedPos, SFX_ID_ENVIRONMENT_FALL_DOWN_DIRT);
    func_80078914(&this->actor.projectedPos, SFX_ID_VOICE_RT_FALL);
}
...
void func_80AED4FC(EnRu1* this) {
    func_80078914(&this->actor.projectedPos, SFX_ID_ENVIRONMENT_LAND_DIRT);
}
...
void func_80AED520(EnRu1* this, PlayState* play) {
    ...
    func_80078914(&this->actor.projectedPos, SFX_ID_VOICE_RT_LIFT);
}

void func_80AED57C(EnRu1* this) {
    if (this->actor.speedXZ != 0.0f) {
        func_80078914(&this->actor.projectedPos, SFX_ID_VOICE_RT_THROW);
    }
}

void func_80AED5B8(EnRu1* this) {
    func_80078914(&this->actor.projectedPos, SFX_ID_VOICE_RT_CRASH);
}

void func_80AED5DC(EnRu1* this) {
    func_80078914(&this->actor.projectedPos, SFX_ID_VOICE_RT_UNBALLANCE);
}

void func_80AED600(EnRu1* this) {
    func_80078914(&this->actor.projectedPos, SFX_ID_VOICE_RT_DISCOVER);
}
