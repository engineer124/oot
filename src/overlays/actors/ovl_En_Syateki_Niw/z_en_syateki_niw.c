    ...
    switch (this->unk_29A) {
        ...
        case 4:
            if (this->unk_25A == 0) {
                ...
                this->unk_280 = 14000.0f;
                this->unk_278 = 14000.0f;
                Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_CHICKEN_CRY_M);
        ...
        case 5:
            ...
            if ((this->unk_25A == 0) && ((player->actor.world.pos.z - 30.0f) < this->actor.world.pos.z)) {
                AudioSfx_PlaySfx(SFX_ID_VOICE_LI_DOWN, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
...
void EnSyatekiNiw_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_262 == 0) {
        if (this->actionFunc == func_80B11E78) {
            this->unk_262 = 0x12C;
            Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_CHICKEN_CRY_N);
        } else {
            this->unk_262 = 0x1E;
            Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_CHICKEN_CRY_A);
        }
