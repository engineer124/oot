...
void func_80B8FEAC(ObjBean* this, PlayState* play) {
    ...
    Actor_PlaySfx_Shared(&this->dyna.actor, NA_SE_PL_PLANT_GROW_UP - SFX_FLAG);
}
...
void ObjBean_GrowWaterPhase2(ObjBean* this, PlayState* play) {
    ...
    Actor_PlaySfx_Shared(&this->dyna.actor, NA_SE_PL_PLANT_TALLER - SFX_FLAG);
}
...
void ObjBean_Fly(ObjBean* this, PlayState* play) {
    ...
    if (this->currentPointIndex == this->pathCount) {
        ...
        Actor_PlaySfx_Shared(&this->dyna.actor, NA_SE_PL_PLANT_MOVE - SFX_FLAG);
