    ...
    switch (this->csState) {
        ...
        case 4:
            ...
            if (this->unk_198 == 0x64) {
                Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_OTAKEBI);
            }
...
void BossDodongo_Explode(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1DA == 0) {
        ...
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_DAMAGE);
...
void BossDodongo_Vulnerable(BossDodongo* this, PlayState* play) {
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_DOWN - SFX_FLAG);
    this->unk_1BE = 10;
    Math_SmoothStepToF(&this->unk_1F8, 1.0f, 0.5f, 0.02f, 0.001f);
    Math_SmoothStepToF(&this->unk_208, 0.05f, 1.0f, 0.005f, 0.0f);
    SkelAnime_Update(&this->skelAnime);
...
void BossDodongo_BlowFire(BossDodongo* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->skelAnime, 12.0f)) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_CRY);
    }
...
void BossDodongo_Inhale(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1AC > 20) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_BREATH - SFX_FLAG);
    }
    ...
    if (this->unk_1DA == 0) {
        ...
        if ((this->unk_1AC > 20) && (this->unk_1AC < 82) && BossDodongo_AteExplosive(this, play)) {
            Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_DRINK);
...
void BossDodongo_Roll(BossDodongo* this, PlayState* play) {
    ...
    if (this->unk_1DA == 1) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_COLI2);
    }
    ...
    if (this->unk_1DA == 0) {
        ...
        if (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND) {
            ...
            Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_ROLL - SFX_FLAG);
    ...
    if (fabsf(sp4C) <= 15.0f && fabsf(sp48) <= 15.0f) {
        ...
        if (this->numWallCollisions >= 2) {
            ...
            Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_COLI);
...
void BossDodongo_SetupDeathCutscene(BossDodongo* this) {
    ...
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_DEAD);
    this->unk_1DA = 0;
    this->csState = 0;
...
void BossDodongo_DeathCutscene(BossDodongo* this, PlayState* play) {
    ...
    switch (this->csState) {
        ...
        case 9:
            ...
            if (this->unk_1DA == 904) {
                Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_END);
            }
            if (this->unk_1DA < 854) {
                Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_LAST - SFX_FLAG);
            }
            if (this->unk_1DA == 960) {
                Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_DODO_K_LAVA);
            }
            if (this->unk_1DA < 960) {
