...
void func_80AE4F40(EnReeba* this, PlayState* play) {
    ...
    if (this->isBig) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIVA_BIG_APPEAR);
    } else {
...
void func_80AE5270(EnReeba* this, PlayState* play) {
    ...
    if ((surfaceType != FLOOR_TYPE_4) && (surfaceType != FLOOR_TYPE_7)) {
        ...
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIVA_MOVE);
        this->unk_274 = 10;
    }
}
...
void func_80AE5A9C(EnReeba* this, PlayState* play) {
    ...
    if (this->unk_278 != 0) {
        ...
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIVA_DEAD);
            ...
            switch (this->actor.colChkInfo.damageEffect) {
                ...
                case 14:
                    ...
                    if (this->actor.colChkInfo.health == 0) {
                        ...
                        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_RIVA_DAMAGE);
