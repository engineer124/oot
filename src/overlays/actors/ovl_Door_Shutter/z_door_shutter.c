    ...
    if (this->unk_164 != 0) {
        ...
        if (this->unk_16E != 0) {
            ...
            if (this->doorType != SHUTTER_BOSS) {
                ...
                Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_CHAIN_KEY_UNLOCK);
            } else {
                Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_CHAIN_KEY_UNLOCK_B);
            }
        }
    } else {
...
s32 func_80996D14(DoorShutter* this, PlayState* play) {
    if (this->unk_16C != 3) {
        ...
        if (this->unk_166 == 100) {
            Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_BUYODOOR_OPEN);
            func_80996C60(this, play);
        }
...
s32 func_80996E08(DoorShutter* this, PlayState* play, f32 arg2) {
    if (this->unk_170 == 1.0f - arg2) {
        if (this->unk_16C != 3) {
            if (arg2 == 1.0f) {
                Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_METALDOOR_CLOSE);
            } else {
                Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_METALDOOR_OPEN);
            }
        } else {
            if (arg2 == 1.0f) {
                Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_BUYOSHUTTER_CLOSE);
            } else {
                Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_BUYOSHUTTER_OPEN);
            }
        }
    }
    ...
    if (DECR(this->unk_16E) == 0 && play->roomCtx.status == 0 && func_80996D14(this, play) != 0) {
        if (((this->doorType == SHUTTER_BOSS) ? 20.0f : 50.0f) < this->dyna.actor.xzDistToPlayer) {
            ...
            if (this->unk_16C != 3) {
                ...
                Actor_PlaySfx(&this->dyna.actor, SFX_ID_ENVIRONMENT_BUYODOOR_CLOSE);
