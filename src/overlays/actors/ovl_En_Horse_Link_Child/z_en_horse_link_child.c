...
void func_80A693D0(EnHorseLinkChild* this) {
    ...
    if ((this->skin.skelAnime.curFrame > D_80A6AF5C[this->unk_1F0]) &&
        ...
        AudioSfx_PlaySfx(NA_SE_EV_KID_HORSE_WALK, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
...
void func_80A6948C(EnHorseLinkChild* this) {
    if (this->animationIdx == 2) {
        ...
        if ((this->animationIdx == 3) || (this->animationIdx == 4)) {
            AudioSfx_PlaySfx(NA_SE_EV_KID_HORSE_RUN, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
                             &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
        } else if (this->animationIdx == 1) {
            if (Rand_ZeroOne() > 0.5f) {
                AudioSfx_PlaySfx(NA_SE_EV_KID_HORSE_GROAN, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
                                 &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
            } else {
                AudioSfx_PlaySfx(NA_SE_EV_KID_HORSE_NEIGH, &this->actor.projectedPos, 4, &gSfxDefaultFreqAndVolScale,
                                 &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
            }
        }
    }
