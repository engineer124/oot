...
void EnBa_SwingAtPlayer(EnBa* this, PlayState* play) {
    ...
    if ((this->actor.xzDistToPlayer <= 175.0f) || (this->unk_31A != 0)) {
        if (this->unk_318 == 20) {
            Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BALINADE_HAND_UP);
            this->unk_31C = 1500;
        }
        if (this->unk_318 != 0) {
            this->unk_31A = 10;
            ...
            if (this->unk_31A == 10) {
                Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BALINADE_HAND_DOWN);
            }
            if (this->unk_31A != 0) {
                this->unk_31C = 8000;
...
void func_809B7174(EnBa* this) {
    ...
    this->actor.colChkInfo.mass = MASS_IMMOVABLE;
    this->actor.speedXZ = 10.0f;
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_BALINADE_HAND_DAMAGE);
...
void func_809B75A0(EnBa* this, PlayState* play2) {
    ...
    this->unk_31C = 2500;
    EffectSsDeadSound_SpawnStationary(play, &this->actor.projectedPos, SFX_ID_ENEMY_BALINADE_HAND_DEAD, 1, 1, 40);
    this->unk_14C = 0;
