    ...
    switch (D_80B7A694) {
        case 0:
            ...
            if (D_80B7E0B4 == 0) {
                ...
                if (D_80B7E0B4 == 18) {
                    ...
                    func_80078914(&D_80B7AF94, SFX_ID_ITEM_SWORD_SWING_HARD);
                }
            }
            break;
        ...
        case 1:
            ...
            if (CHECK_BTN_ALL(input->cur.button, BTN_A) || (D_80B7A68C != 0)) {
                ...
                D_80B7E0E8.z *= 0.9f;
                if (D_80B7A68C == 0) {
                    func_80078884(SFX_ID_ITEM_FISHING_REEL_HIGH - SFX_FLAG);
                }
            }
            ...
            if (spC8 > SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    func_80078914(&D_80B7AF94, SFX_ID_ENEMY_FANTOM_FLOAT - SFX_FLAG);
                }
            } else {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if ((sLurePos.y <= spE4) && (spE4 < spE0) && (spE4 == WATER_SURFACE_Y(play))) {
                        D_80B7E114 = 10;
                        func_80078914(&D_80B7AF94, SFX_ID_ENVIRONMENT_BOMB_DROP_WATER);
                        D_80B7E0F8.y = 0.0f;
                        D_80B7E0E8.y *= 0.2f;
        ...
        case 3:
            ...
            if (spC8 < SQ(920.0f)) {
                if (sLurePos.y <= (spE4 + 4.0f)) {
                    ...
                    if ((sp70 > 0.2f) && (D_80B7E138 < 4.0f)) {
                        ...
                        Audio_PlaySfx_AtPosWithFreq(&D_80B7AF94, SFX_ID_ENVIRONMENT_LURE_MOVE_W,
                                                    (sp70 * 1.999f * 0.25f) + 0.75f);
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if (CHECK_BTN_ALL(input->press.button, BTN_B)) {
                        D_80B7E144 += 6.0f;
                        func_80078914(&D_80B7AF94, SFX_ID_PLAYER_WALK_SAND);
                    }
                } else {
                    if (D_80B7E144 > 150.0f) {
                        sLureRot.x = sReelLineRot[LINE_SEG_COUNT - 2].x + M_PI;
            ...
            if (CHECK_BTN_ALL(input->cur.button, BTN_A)) {
                if (CHECK_BTN_ALL(input->cur.button, BTN_R)) {
                    ...
                    func_80078884(SFX_ID_ITEM_FISHING_REEL_SLOW - SFX_FLAG);
...
void func_80B71278(Fishing* this, u8 arg1) {
    ...
    if (arg1 == 0) {
        if (temp >= 50) {
            sfxId = SFX_ID_ENVIRONMENT_DIVE_INTO_WATER;
        } else if (temp >= 40) {
            sfxId = SFX_ID_ENVIRONMENT_BOMB_DROP_WATER;
        } else {
            sfxId = SFX_ID_ENVIRONMENT_BOMB_DROP_WATER;
        }
    } else {
        if (temp >= 50) {
            sfxId = SFX_ID_ENVIRONMENT_JUMP_OUT_WATER;
        } else if (temp >= 40) {
            sfxId = SFX_ID_ENVIRONMENT_OUT_OF_WATER;
        } else {
            sfxId = SFX_ID_ENVIRONMENT_OUT_OF_WATER;
        }
    }
        ...
        case -3:
            ...
            if ((D_80B7A694 != 3) || (this->unk_17A[0] == 0) || (sLurePos.y > (WATER_SURFACE_Y(play) + 5.0f)) ||
                ...
                if (sLurePos.y > (WATER_SURFACE_Y(play) - 10.0f)) {
                    Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_JUMP_OUT_WATER);
                    func_80078884(SFX_ID_PLAYER_CATCH_BOOMERANG);
                }
        ...
        case 5:
            ...
            if ((D_80B7E122 != 0) && (D_80B7E124 == 0)) {
                if (((input->rel.stick_y < -50) && (D_80B7A6C8 > -40)) || CHECK_BTN_ALL(input->press.button, BTN_A)) {
                    ...
                    D_80B7E0A4 = 40;
                    D_80B7FDA8 = 10;
                    func_80078884(SFX_ID_ITEM_FISHING_HIT);
                }
            }
        ...
        if ((this->actor.speedXZ > 0.0f) || (this->unk_158 == 5)) {
            ...
            if (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND) {
                if (this->actor.world.pos.y > WATER_SURFACE_Y(play)) {
                    ...
                    Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_FISH_LEAP);
...
void Fishing_UpdateOwner(Actor* thisx, PlayState* play2) {
            ...
            if (CHECK_BTN_ALL(input->press.button, BTN_Z)) {
                if ((D_80B7E088 >= 0) && (D_80B7E122 == 0)) {
                    ...
                    if ((D_80B7E088 == 0) || (D_80B7E088 == 3)) {
                        func_80078884(SFX_ID_SYSTEM_CAMERA_ZOOM_DOWN);
                    } else {
    ...
    if (D_80B7A65C.z < 1500.0f) {
        Audio_PlaySfx_AtPosWithFreq(&D_80B7A65C, SFX_ID_ENVIRONMENT_RAIN - SFX_FLAG, D_80B7A668);
    }
    ...
    func_80078914(&sStreamSfxProjectedPos, SFX_ID_ENVIRONMENT_WATER_WALL - SFX_FLAG);
