        ...
        case 0:
            ...
            if (D_80B7E0B4 == 0) {
                ...
                if (D_80B7E0B4 == 18) {
                    ...
                    Audio_PlaySfx_AtPos(&D_80B7AF94, NA_SE_IT_SWORD_SWING_HARD);
                }
            }
            break;
        ...
        case 1:
            ...
            if (spC8 > SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    Audio_PlaySfx_AtPos(&D_80B7AF94, NA_SE_EN_FANTOM_FLOAT - SFX_FLAG);
                }
            } else {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if ((sLurePos.y <= spE4) && (spE4 < spE0) && (spE4 == WATER_SURFACE_Y(play))) {
                        D_80B7E114 = 10;
                        Audio_PlaySfx_AtPos(&D_80B7AF94, NA_SE_EV_BOMB_DROP_WATER);
                        D_80B7E0F8.y = 0.0f;
                        D_80B7E0E8.y *= 0.2f;
        ...
        case 3:
            ...
            if (spC8 < SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if (CHECK_BTN_ALL(input->press.button, BTN_B)) {
                        D_80B7E144 += 6.0f;
                        Audio_PlaySfx_AtPos(&D_80B7AF94, NA_SE_PL_WALK_GROUND + SURFACE_SFX_OFFSET_SAND);
                    }
                } else {
                    if (D_80B7E144 > 150.0f) {
                        sLureRot.x = sReelLineRot[LINE_SEG_COUNT - 2].x + M_PI;
...
void Fishing_UpdateOwner(Actor* thisx, PlayState* play2) {
    ...
    if ((D_80B7A684 != 0) || (Message_GetState(&play->msgCtx) != TEXT_STATE_NONE)) {
        ...
        this->actor.flags |= ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_NO_DRAW_CULLING;
    }
    ...
    Audio_PlaySfx_AtPos(&sStreamSfxProjectedPos, NA_SE_EV_WATER_WALL - SFX_FLAG);
