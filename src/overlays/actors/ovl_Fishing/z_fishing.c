    ...
    switch (D_80B7A694) {
        case 0:
            ...
            if (D_80B7E0B4 == 0) {
                ...
                if (D_80B7E0B4 == 18) {
                    ...
                    Lib_PlaySfxAtPos(&D_80B7AF94, NA_SE_IT_SWORD_SWING_HARD);
                }
            }
            break;
        ...
        case 1:
            ...
            if (CHECK_BTN_ALL(input->cur.button, BTN_A) || (D_80B7A68C != 0)) {
                ...
                D_80B7E0E8.z *= 0.9f;
                if (D_80B7A68C == 0) {
                    Lib_PlaySfx1(NA_SE_IT_FISHING_REEL_HIGH - SFX_FLAG);
                }
            }
            ...
            if (spC8 > SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    Lib_PlaySfxAtPos(&D_80B7AF94, NA_SE_EN_FANTOM_FLOAT - SFX_FLAG);
                }
            } else {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if ((sLurePos.y <= spE4) && (spE4 < spE0) && (spE4 == WATER_SURFACE_Y(globalCtx))) {
                        D_80B7E114 = 10;
                        Lib_PlaySfxAtPos(&D_80B7AF94, NA_SE_EV_BOMB_DROP_WATER);
                        D_80B7E0F8.y = 0.0f;
                        D_80B7E0E8.y *= 0.2f;
        ...
        case 3:
            ...
            if (spC8 < SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if (CHECK_BTN_ALL(input->press.button, BTN_B)) {
                        D_80B7E144 += 6.0f;
                        Lib_PlaySfxAtPos(&D_80B7AF94, NA_SE_PL_WALK_SAND);
                    }
                } else {
                    if (D_80B7E144 > 150.0f) {
                        sLureRot.x = sReelLineRot[LINE_SEG_COUNT - 2].x + M_PI;
            ...
            if (CHECK_BTN_ALL(input->cur.button, BTN_A)) {
                if (CHECK_BTN_ALL(input->cur.button, BTN_R)) {
                    ...
                    Lib_PlaySfx1(NA_SE_IT_FISHING_REEL_SLOW - SFX_FLAG);
...
void func_80B71278(Fishing* this, u8 arg1) {
    ...
    Actor_PlaySfxAtPos1(&this->actor, sfxId);
}
            ...
            if ((this->actor.xzDistToPlayer < (250.0f * sp118)) || (this->unk_17A[1] != 0)) {
                ...
                if (this->actor.world.pos.y < (WATER_SURFACE_Y(globalCtx) - 20.0f)) {
                    ...
                    if ((this->actor.speedXZ == 0.0f) ||
                        ...
                        Actor_PlaySfxAtPos1(&this->actor, NA_SE_PL_CATCH_BOOMERANG);
                        break;
                    }
                }
        ...
        case -3:
            ...
            if ((D_80B7A694 != 3) || (this->unk_17A[0] == 0) || (sLurePos.y > (WATER_SURFACE_Y(globalCtx) + 5.0f)) ||
                ...
                if (sLurePos.y > (WATER_SURFACE_Y(globalCtx) - 10.0f)) {
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EV_JUMP_OUT_WATER);
                    Lib_PlaySfx1(NA_SE_PL_CATCH_BOOMERANG);
                }
        ...
        case 5:
            ...
            if ((D_80B7E122 != 0) && (D_80B7E124 == 0)) {
                if (((input->rel.stick_y < -50) && (D_80B7A6C8 > -40)) || CHECK_BTN_ALL(input->press.button, BTN_A)) {
                    ...
                    D_80B7E0A4 = 40;
                    D_80B7FDA8 = 10;
                    Lib_PlaySfx1(NA_SE_IT_FISHING_HIT);
                }
            }
        ...
        if ((this->actor.speedXZ > 0.0f) || (this->unk_158 == 5)) {
            ...
            if (this->actor.bgCheckFlags & 1) {
                if (this->actor.world.pos.y > WATER_SURFACE_Y(globalCtx)) {
                    ...
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EV_FISH_LEAP);
...
void Fishing_UpdateOwner(Actor* thisx, GlobalContext* globalCtx2) {
            ...
            if (CHECK_BTN_ALL(input->press.button, BTN_Z)) {
                if ((D_80B7E088 >= 0) && (D_80B7E122 == 0)) {
                    ...
                    if ((D_80B7E088 == 0) || (D_80B7E088 == 3)) {
                        Lib_PlaySfx1(NA_SE_SY_CAMERA_ZOOM_DOWN);
                    } else {
    ...
    Lib_PlaySfxAtPos(&sStreamSoundProjectedPos, NA_SE_EV_WATER_WALL - SFX_FLAG);
