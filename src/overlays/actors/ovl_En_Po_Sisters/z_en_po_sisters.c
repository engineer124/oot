...
void func_80AD9718(EnPoSisters* this) {
    ...
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_PO_LAUGH2);
...
void func_80ADA2BC(EnPoSisters* this, GlobalContext* globalCtx) {
    ...
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EV_FLAME_IGNITION);
...
void func_80ADA7F0(EnPoSisters* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_19A == 18 || this->unk_19A == 7) {
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_PO_ROLL);
    }
    if (this->unk_19A == 0) {
        func_80AD94E0(this);
    }
...
void func_80ADB2B8(EnPoSisters* this, GlobalContext* globalCtx) {
    ...
    if (Animation_OnFrame(&this->skelAnime, 0.0f)) {
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_PO_CRY);
    }
    this->actor.shape.rot.y = this->actor.yawTowardsPlayer;
}
    ...
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if (this->unk_195 != 0) {
            ...
            if (Actor_ApplyDamage(&this->actor) != 0) {
                ...
                Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_PO_SISTER_DEAD);
            }
            func_80AD95D8(this);
        }
    }
