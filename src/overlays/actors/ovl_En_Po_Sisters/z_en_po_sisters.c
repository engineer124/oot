...
void func_80AD9718(EnPoSisters* this) {
    ...
    Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_PO_LAUGH2);
...
void func_80ADA2BC(EnPoSisters* this, PlayState* play) {
    ...
    Actor_PlaySfx(&this->actor, SFX_ID_ENVIRONMENT_FLAME_IGNITION);
...
void func_80ADA7F0(EnPoSisters* this, PlayState* play) {
    ...
    if (this->unk_19A == 18 || this->unk_19A == 7) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_PO_ROLL);
    }
    if (this->unk_19A == 0) {
        func_80AD94E0(this);
    }
...
void func_80ADB17C(EnPoSisters* this, PlayState* play) {
    ...
    if (this->unk_19A == 64) {
        ...
        SfxSource_PlaySfxAtFixedWorldPos(play, &this->actor.world.pos, 30, SFX_ID_ENVIRONMENT_FLAME_IGNITION);
        if (this->unk_194 == 0) {
...
void func_80ADB2B8(EnPoSisters* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->skelAnime, 0.0f)) {
        Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_PO_CRY);
    }
    this->actor.shape.rot.y = this->actor.yawTowardsPlayer;
}
...
void func_80ADBF58(EnPoSisters* this, PlayState* play) {
    ...
    if (this->unk_19A == -70 && this->unk_194 == 1) {
        SfxSource_PlaySfxAtFixedWorldPos(play, &D_80ADD7BC, 40, SFX_ID_ENEMY_PO_LAUGH);
    }
    if (this->unk_19A < -120) {
        Actor_Kill(&this->actor);
    }
    ...
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if (this->unk_195 != 0) {
            ...
            if (Actor_ApplyDamage(&this->actor) != 0) {
                ...
                Actor_PlaySfx(&this->actor, SFX_ID_ENEMY_PO_SISTER_DEAD);
            }
            func_80AD95D8(this);
        }
    }
