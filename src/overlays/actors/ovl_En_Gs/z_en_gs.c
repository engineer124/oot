...
void func_80A4ED34(EnGs* this, PlayState* play) {
        ...
        if ((this->unk_200 < 80) && ((this->unk_200 % 20) < 8)) {
            if (this->unk_200 < 20) {
                ...
                if ((this->unk_200 % 20) == 7) {
                    AudioSfx_PlaySfx(NA_SE_SY_WARNING_COUNT_E, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                }
            } else {
                Color_RGBA8_Copy(&this->flashColor, &flashBlue);
                if ((this->unk_200 % 20) == 7) {
                    AudioSfx_PlaySfx(NA_SE_SY_WARNING_COUNT_N, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
                                     &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
                }
            }
        }
    ...
    if (this->unk_19F == 3) {
        ...
        Actor_PlaySfx_Shared(&this->actor, NA_SE_EV_FIRE_PILLAR - SFX_FLAG);
        if (this->unk_200++ >= 40) {
            this->unk_19E |= 0x10;
    ...
    if (this->unk_19F == 4) {
        ...
        if (this->actor.bgCheckFlags & (BGCHECKFLAG_WALL | BGCHECKFLAG_CEILING)) {
            ...
            Actor_PlaySfx_Shared(&this->actor, NA_SE_EV_STONE_LAUNCH - SFX_FLAG);
        }
