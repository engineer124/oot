...
void func_809BCF68(EnBigokuta* this, GlobalContext* globalCtx) {
    ...
    if (this->actionFunc != func_809BE4A4) {
        Actor_PlaySfxAtPos3(&this->actor, NA_SE_EN_DAIOCTA_SPLASH - SFX_FLAG);
    }
}
...
void func_809BD1C8(EnBigokuta* this, GlobalContext* globalCtx) {
    ...
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DAIOCTA_LAND_WATER);
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_GOLON_LAND_BIG);
...
void func_809BD524(EnBigokuta* this) {
    ...
    this->unk_19A = 0;
    this->cylinder[0].base.atFlags |= AT_ON;
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DAIOCTA_MAHI);
...
void func_809BD658(EnBigokuta* this) {
    ...
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DAIOCTA_DEAD2);
    this->unk_196 = 38;
    this->unk_198 = 10;
...
void func_809BD768(EnBigokuta* this) {
    ...
    this->cylinder[0].base.atFlags &= ~AT_ON;
    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DAIOCTA_SINK);
...
void func_809BD84C(EnBigokuta* this, GlobalContext* globalCtx) {
    ...
    if (this->unk_196 == 13 || this->unk_196 == -20) {
        Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DAIOCTA_VOICE);
    }
    if (this->unk_196 == 1) {
        ...
        if (this->actor.colChkInfo.damageEffect != 0 || this->actor.colChkInfo.damage != 0) {
            if (this->actor.colChkInfo.damageEffect == 1) {
                ...
                if (Actor_ApplyDamage(&this->actor) == 0) { // Dead
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DAIOCTA_DEAD);
                    Enemy_StartFinishingBlow(globalCtx, &this->actor);
                } else {
                    Actor_PlaySfxAtPos1(&this->actor, NA_SE_EN_DAIOCTA_DAMAGE);
                }
                func_809BD5E0(this);
            }
        }
